...
//       <div className="space-y-8 bg-white/80 dark:bg-muted rounded-xl shadow-md p-6 border">
...
//               <Input id="agentName" placeholder="Ex: Kimbundu" defaultValue="Agente Inteligente" />
//             </div>

//             <div className="space-y-2">
//               <Label htmlFor="language">Idioma Preferido</Label>
//               <Input id="language" placeholder="Ex: Português, Kimbundu..." defaultValue="Português" />
//             </div>
//           </div>
