    ...
    >
      ...
      >
        <motion.textarea
          ...
          className="flex-1 resize-none border rounded-lg p-2 bg-transparent placeholder:text-slate-100 text-[16px] font-bold text-white outline-none overflow-hidden"
        />
